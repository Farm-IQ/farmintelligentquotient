...
} from "./chunk-UO76IYRC.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-4B5JDM4Q.js";
import "./chunk-7WXZJNPG.js";
import {
  isRTL
} from "./chunk-X4OYSLM3.js";
import {
...
} from "./chunk-TPHGVEPS.js";
import {
  transition
} from "./chunk-PKSMZKQ7.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-ceb5RaMT-362ENLFE.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-5DQ7Fc4V-4URXNIJZ.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-D6H3ZaWt-UESFCIM6.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = await import("./hardware-back-button-CPLxO-Ev-XTLTO2IN.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-435CT2TQ.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-DEROZSDK.js").then((module) => this.focusVisible = module.startFocusVisible());
      });
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import("./swipe-back-BKw2CAHc-6QJGNTRN.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
      var _a;
...
//# sourceMappingURL=ion-app_8.entry-OWYRO242.js.map
