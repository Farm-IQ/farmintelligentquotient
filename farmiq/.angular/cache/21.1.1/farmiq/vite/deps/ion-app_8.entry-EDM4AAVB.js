...
} from "./chunk-65CKUAMP.js";
import {
  transition
} from "./chunk-KTYU3XSG.js";
import "./chunk-DWC2MENN.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-VZBJUKWZ.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-ceb5RaMT-LIHMY3VE.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-5DQ7Fc4V-O5BIJAHG.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-D6H3ZaWt-QQ7C5AJB.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = await import("./hardware-back-button-CPLxO-Ev-AVIENARH.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-EYDLPYK5.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-YBLKK35Y.js").then((module) => this.focusVisible = module.startFocusVisible());
      });
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  async connectedCallback() {
    ...
    this.gesture = (await import("./swipe-back-BKw2CAHc-2NGZQXFF.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
      var _a;
...
//# sourceMappingURL=ion-app_8.entry-EDM4AAVB.js.map
